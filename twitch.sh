...
VBR="1000k" # AQUI É A TAXA DE BITS, DE 128 A 4000 A QUALODADE MUDA E PODE SER PERSONALIZADO
FPS="15" # TAXA DE FPS QUE VOCE QUER NO VIDEO, RECOMENDO ABAIXO DE 25
QUAL="ultrafast"
 
TWITCH="rtmp://live-fra.twitch.tv/app" # O SERVIDOR PODE SER MODIFICADO PARA OUTROS BR, VEJA A LISTA EM https://stream.twitch.tv/ingests/
